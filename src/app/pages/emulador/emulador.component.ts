...
export class EmuladorComponent implements OnInit, OnDestroy {
    ...
    cargarMapaLeaflet() {
        ...
        this.mapService.rootMap.on('click', (e) => {     
            ...
            const payload = {
                ...
                imei: '1234567890',
                id_conexion: 0,
                ult_lat: popLocation.lat,
                ult_lng: popLocation.lng,
                timerParking: 10,
                timerMoving: 10,
                ign: this.ign,
                ult_vel: 10,
            ...
            this.lat = popLocation.lat;
            this.lng = popLocation.lng;
            
            console.log('Emitiendo posicion');

            this.wsService.emit('marcador-mover', payload);
    ...
    agregarMarcadorLeaflet(marcador: any) {
        ...
        this.nombreVehiculo = marcador.nombre;
    ...
    escucharSockets() {
        ...
        this.subWsMarcadorMover = this.wsService.listen('marcador-mover').subscribe((device: Device) => {
                ...
                if (vehiculo !== undefined) {
                    ...
                    if (Number(this.vehiculoASeguir) === Number(device.imei)) {
                        ...
                        if (this.localStorageService.monitoreo3.popupZoom) {
                            this.mapService.rootMap.setView([device.ult_lat + 0.008655, device.ult_lng]);
                        } else {
                            this.mapService.rootMap.setView([device.ult_lat + 0.000255, device.ult_lng]);
                        }
                    }
