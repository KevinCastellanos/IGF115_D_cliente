...
@Component({
  selector: 'app-dialog-ver-geocercas-triggers',
  templateUrl: './dialog-ver-geocercas-triggers.component.html',
  styleUrls: ['./dialog-ver-geocercas-triggers.component.css']
})
export class DialogVerGeocercasTriggersComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(public dialogRef: MatDialogRef<DialogVerGeocercasTriggersComponent>,
