...
@Component({
  selector: 'app-dialog-ver-vehiculos-triggers',
  templateUrl: './dialog-ver-vehiculos-triggers.component.html',
  styleUrls: ['./dialog-ver-vehiculos-triggers.component.css']
})
export class DialogVerVehiculosTriggersComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(public dialogRef: MatDialogRef<DialogVerVehiculosTriggersComponent>,
